...
def api_contract_access_tests(selected_api_contract_data):
    ...
    endpoint_description = bll.dal.api_contract_accessor.get_endpoint_description(selected_path, selected_http_operation, selected_api_contract_json)
    print("endpoint_description")
    print(endpoint_description)

    endpoint_operationId = bll.dal.api_contract_accessor.get_endpoint_operationId(selected_path, selected_http_operation, selected_api_contract_json)
    print("endpoint_operationId")
    print(endpoint_operationId)

    endpoint_parameter_list = bll.dal.api_contract_accessor.get_endpoint_parameter_list(selected_path, selected_http_operation, selected_api_contract_json)
    print("endpoint_parameter_list")
    print(endpoint_parameter_list)

    endpoint_responses_list = bll.dal.api_contract_accessor.get_endpoint_response_list(selected_path, selected_http_operation, selected_api_contract_json)
    print("endpoint_responses_list")
    print(endpoint_responses_list)

    selected_response_code = endpoint_responses_list[1]

    endpoint_response_description = bll.dal.api_contract_accessor.get_endpoint_response_description(selected_path, selected_http_operation, selected_response_code, selected_api_contract_json)
    print("endpoint_response_description")
    print(endpoint_response_description)


    endpoint_response_content = bll.dal.api_contract_accessor.get_endpoint_response_content(selected_path, selected_http_operation, selected_response_code, selected_api_contract_json)
    print("endpoint_response_content")
    print(endpoint_response_content)


    endpoint_request_body = bll.dal.api_contract_accessor.get_endpoint_request_body(selected_path, selected_http_operation, selected_api_contract_json)
    print("endpoint_request_body")
    print(endpoint_request_body)


    component_schema_list = bll.dal.api_contract_accessor.get_component_schema_list(selected_api_contract_json)
    print("component_schema_list")
    print(component_schema_list)

    selected_schema = component_schema_list[2]
    component_schema_data = bll.dal.api_contract_accessor.get_component_schema_data(selected_schema, selected_api_contract_json)
    print("component_schema_data")
    print(component_schema_data)

    security_scheme = bll.dal.api_contract_accessor.get_security_scheme(selected_api_contract_json)
    print("security_scheme")
    print(security_scheme)

    contract_intel = bll.dal.api_contract_accessor.get_contract_intel(selected_api_contract_json)
